...
function myFunction(){document.getElementById("myDropdown").classList.toggle("show")}function myFunctionHeadphones(){document.getElementById("myHeadphones").classList.toggle("show")}function myFunctionWireless(){document.getElementById("myWireless").classList.toggle("show")}function myFunctionFind(){document.getElementById("myFind").classList.toggle("show")}$(function(){$(".menu a, .totop").on("click",function(e){e.preventDefault();e=$(this).attr("href"),e=$(e).offset().top;$("body,html").animate({scrollTop:e},1500)}),$(".slider-blog__inner").slick({arrows:!1,dots:!0,autoplay:!0,autoplaySpeed:3e3,fade:!0,responsive:[{breakpoint:768,settings:{arrows:!1}}]}),$(".menu__btn, .menu a").on("click",function(){$(".menu__list").toggleClass("menu__list--active")}),$(".radio input").on("click",function(e){console.clear(),console.log(this.checked),e.preventDefault(),setTimeout(()=>$(this).prop("checked",!this.checked).trigger("change"))})}),window.onclick=function(e){if(!e.target.matches(".dropbtn"))for(var t=document.getElementsByClassName("dropdown-content"),s=0;s<t.length;s++){var n=t[s];n.classList.contains("show")&&n.classList.remove("show")}};var $stepper=document.querySelector(".stepper");if($stepper){let s=$stepper.querySelector(".stepper__input"),n=$stepper.querySelector(".stepper__btn--minus"),l=$stepper.querySelector(".stepper__btn--plus");s&&n&&l&&(s.addEventListener("keydown",e=>{console.log(e.currentTarget.value),(e.currentTarget.value<=1?(n.classList.add("stepper__btn--disabled"),l):n).classList.remove("stepper__btn--disabled"),99998<e.currentTarget.value?(n.classList.remove("stepper__btn--disabled"),l.classList.add("stepper__btn--disabled")):l.classList.remove("stepper__btn--disabled")}),l.addEventListener("click",e=>{var t=parseInt(s.value);t++,s.value=t,n.classList.remove("stepper__btn--disabled"),99998<s.value?(s.value=99999,l.classList.add("stepper__btn--disabled")):l.classList.remove("stepper__btn--disabled")}),n.addEventListener("click",e=>{var t=parseInt(s.value);t--,s.value=t,l.classList.remove("stepper__btn--disabled"),s.value<=1?(s.value=1,n.classList.add("stepper__btn--disabled")):n.classList.remove("stepper__btn--disabled")}))}